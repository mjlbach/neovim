...
describe("string() function", function()
  ...
  describe("used to represent lists", function()
    ...
    it("errors when dumping recursive lists", function()
      meths.set_var("l", {})
      eval "add(l, l)"
      eq("Vim(echo):E724: unable to correctly dump variable with self-referencing container", exc_exec "echo string(l)")
    end)
  ...
  describe("used to represent dictionaries", function()
    ...
    it("errors when dumping recursive dictionaries", function()
      meths.set_var("d", { d = 1 })
      eval 'extend(d, {"d": d})'
      eq("Vim(echo):E724: unable to correctly dump variable with self-referencing container", exc_exec "echo string(d)")
    end)
