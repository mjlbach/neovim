...
describe("lua: nvim_buf_attach on_bytes", function()
  ...
  local function do_both(verify)
    ...
    it("nvim_buf_set_text insert", function()
      ...
      eq({ "basfiol", "kontrapunkt", "syntgitarr", "övningstext" }, meths.buf_get_lines(0, 0, -1, true))
    end)
    ...
    it("nvim_buf_set_text delete", function()
      ...
      eq(
        { "original line 2", "original line 3", "original line 4", "original line 5", "original line 6" },
