...
describe("API: buffer events:", function()
  it("when lines are added", function()
    ...
    expectn(
      "nvim_buf_lines_event",
      { b, tick, 3, 3, { "original line 4", "original line 5", "original line 6", "original line 4" }, false }
    )
  ...
  it("when text is changed", function()
    ...
    sendkeys "<C-v>jjllx"
    tick = tick + 1
    expectn("nvim_buf_lines_event", { b, tick, 2, 5, { "original e 3", "original e 4", "original e 5" }, false })
  ...
  it("works with :move", function()
    ...
    expectn("nvim_buf_lines_event", {
      ...
      2,
      2,
      { "original line 4", "original line 5" },
      false,
    })
    tick = tick + 1
